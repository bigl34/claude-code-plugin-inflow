...
- Credentials in `pass`: `your-secret-store/inflow-billing/email`, `your-secret-store/inflow-billing/password`, `your-secret-store/inflow-billing/totp-secret`
...
```bash
EMAIL=$(pass your-secret-store/inflow-billing/email)
PASSWORD=$(pass your-secret-store/inflow-billing/password)
```
...
```bash
TOTP_SECRET=$(pass your-secret-store/inflow-billing/totp-secret)
